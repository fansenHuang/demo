...
public class MainController {
    ...
    public String userlist(Map<String, Object> map,String start,String end,String username,@RequestParam(value = "page" ,required = false,defaultValue = "1")Integer page){
    ...
    public String role(Map<String, Object> map,String start,String end,String name,@RequestParam(value = "page" ,required = false,defaultValue = "1")Integer page){
    ...
    public String modulelist(Map<String, Object> map,String name,String type,@RequestParam(value = "page" ,required = false,defaultValue = "1")Integer page){
